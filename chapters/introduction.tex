...
Estos condicionales sirven para responder preguntas del tipo \say{�qu� huibiera sucedido si $x$ hubiera tomado un valor distinto al que tom�?}
...
Un ejemplo de esto son las \emph{Pruebas Controladas Aleatorizadas} (RCT, por sus siglas en ingl�s), donde se interviene en una de las variables --t�picamente un grupo
...
medicamento est� jugando un papel causal. 
...
Potochnik tambi�n afirma que buena parte de la investigaci�n se centra en ofrecer explicaciones causales y, m�s a�n, afirma que una buena manera de
lidiar con explicaciones causales en investigaci�n cient�fica es adoptando una teor�a causal \emph{manipulabilista.} 
