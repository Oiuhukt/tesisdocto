...
por ejemplo, potochnik señala que \say{[…] I make the case that much of
...
causales \parencite{sep-causation-mani}, en corto las teorías
manipulabilistas afirman que dadas dos variables $A$ y $B$, decimos que
$A$ \emph{causa} $B$ si al intervenir en la variable $A$, $B$ cambia en
consecuencia.
