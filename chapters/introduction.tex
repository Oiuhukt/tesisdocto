...
\section{Una breve an�cdota}

\noindent El doctorado ha sido un largo viaje durante el cu�l aprend� mucho. 
Una parte considerable del aprendizaje est� relacionado con la filosof�a,\sidenote{
	Juro que este breve relato tiene un punto. 
	La otra parte de mi aprendizaje no est� relacionado con filosof�a, por tanto no aparecer� en el escrito.
} 
y la alta calidad del posgrado me permiti� profundizar en los temas que me interesaban. 
Quiero mencionar adem�s, que mi inter�s en estos temas naci� durante mi licenciatura. 
Me interes� en filosof�a de la ciencia porque tuve dos profesores tuve durante este periodo; ambos excelentes maestros y excelentes fil�sofos.

Los temas que vimos durante sus clases fueron sumamente interesantes, pero mi atenci�n la dirig� especialmente a los temas de la \emph{explicaci�n cient�fica} y la \emph{naturaleza de la causalidad}. 
Mis intuiciones --todav�a queda un resabio de esto-- se�alaban que encontrar la causa de un fen�meno es la mejor manera de explicar por qu� sucede ese fen�meno.

Esta intuici�n no est� muy alejada de algunas teor�as de la
explicaci�n, por ejemplo, Potochnik se�ala que \say{[$\ldots$] I make the case that much of science is profitably understood as the search for causal patterns.} \parencite[][p.~24]{Potochnik2017-POTIAT-3} 
No s�lo eso, Potochnik tambi�n afirma que son las teor�as \emph{manipulabilistas} \parencite{sep-causation-mani} de la causalidad las que mejor vinculan a la pr�ctica de la investigaci�n cient�fica con la b�squeda de patrones causales. 

\paragraph{Brevemente, las teor�as \emph{manipulabilistas}\sidenote{
	La siguiente caracterizaci�n est� basada en \parencite{sep-causation-mani, sep-causal-explanation-science, Woodward2004, Woodward2000-WOOEAI}
...
Esto, por supuesto s�lo es una parte de la historia de las teor�as \emph{manipulabilistas}. 
Si hay una funci�n bien definida entre las variables, la tarea es ligeramente sencilla.
Pensemos, por ejemplo, en una funci�n cualquiera entre dos variables, digamos que la funci�n est� definida de la siguiente manera $f(x) = 2y$, donde $x \in \mathbb{N}$.
Esto significa que si $x$ toma el $3$ como valor, la variable $y$ tendr� $6$ como valor.

Supongamos que estos son los valores que puede tomar una medida de fuerza.
Digamos que \emph{dos cent�metros} de presi�n en un resorte producen \emph{cuatro metros} de distancia de un proyectil, \emph{independiente} de cualquier fuerza externa, por ejemplo, la fuerza del aire --insisto en que esto es s�lo un caso para ejemplificar. 

Esto significar�a que la compresi�n del resorte \emph{causa} que el proyectil alcance m�s distancia. 
Adem�s es posible que la funci�n definida anteriormente no sea correcta para algunos de los valores de $x$, por ejemplo, si el resorte s�lo mide $8$ cm, llegar� un momento en que el resorte est� completamente comprimido como para que m�s compresi�n haga una diferencia.

El ejemplo anterior sirve para describir algunas de las caracter�sticas de la teor�a \emph{manipulabilista.} 
Que la funci�n describa correctamente el comportamiento del proyectil, \emph{independiente} de otra fuerza, quiere decir que la compresi�n en el resorte es la �nica variable que afecta el traslado del proyectil. 

Que la \emph{intervenci�n} en el resorte cause que el proyectil llegue a mas distancia, \emph{independiente} de cualquier otra fuerza, significa que es posible hacer una intervenci�n \say{quir�rgica} y que s�lo haya ciertos valores que describen correctamente el comportamiento del proyectil, significa que es \emph{invariante} bajo un rango de intervenciones. 
En esto, a grandes rasgos, consiste una teor�a \emph{manipulabilista} de la causalidad.

Hay otras caracter�sticas integran la teor�a \emph{manipulabilista} de la causalidad.
Quiz�s la m�s controversial de ellas es que la teor�a hace uso de condicionales \emph{contraf�cticos.} 
Estos condicionales sirven para responder preguntas del tipo \say{�qu� hubiera sucedido si $x$ hubiera tomado un valor distinto al que tom�?}
En investigaci�n, se suele mencionar el uso de condicionales \emph{contraf�cticos}, principalmente en inferencias causales. 

Si tomamos en serio el trabajo que realizan las personas cuando hacen investigaci�n, es claro que el uso de estas herramientas juega un papel central y, de manera particular, los modelos estad�sticos hacen uso de condicionales \emph{contraf�cticos.} 
Los condicionales \emph{contraf�cticos} son aquellos condicionales que evaluamos bajo el supuesto de que algo no sucede, pero que nos obligan a preguntarnos que pasar�a si se cumplieran ciertas condiciones particulares. 
Dicho de otro modo, nos preguntamos c�mo ser�a el mundo si, por ejemplo, M�xico no hubiera sido conquistado por los espa�oles. 

Estos m�todos sirven, sobre todo, cuando utilizamos modelos estad�sticos para justificar hip�tesis causales \parencite{Pearl2016, Pearl2018}.
Un ejemplo de esto son las \emph{Pruebas Controladas Aleatorizadas} (RCT, por sus siglas en ingl�s), donde se interviene en una de las variables --t�picamente un grupo de control al que se le da un placebo,-- mientras que otro grupo recibe el medicamento a testar.
Este esperando que seamos capaces de detectar si el medicamento est� jugando un papel causal. 
Los condicionales contraf�cticos encuentran su aplicaci�n en estos contextos para \say{crear} un evento alterno.

\paragraph{No voy a hacer una defensa} de la teor�a \emph{manipulabilista} de la causalidad. 
Eso lo hice en mi proyecto de maestr�a, en particular tratando de elucidar c�mo esta teor�a lidia con explicaciones causales en biolog�a evolutiva --sea cual sea el �xito que haya tenido esta defensa,-- con
mi proyecto actual quiero hacer claro c�mo sabemos qu� condicionales \emph{contraf�cticos} son \say{verdaderos}.

Parece que queda claro que herramientas estad�sticas, en el contexto de las inferencias causales, echan mano de \emph{condicionales contraf�cticos.}
Adem�s, son estos condicionales, los que nos permiten trazar relaciones causales seg�n la teor�a \emph{manipulabilista}
Una motivaci�n que se ha mencionado en la literatura para introducir m�todos que nos permitan trazar relaciones causales es la llamada \say{paradoja de Simpson.}
...
Algunos autores han se�alado que la soluci�n radica en ser capaces de ofrecer un m�todo para obtener relaciones causales a partir de datos estad�sticos.

Este tema --el de la explicaci�n causal-- est� fuertemente vinculado con el uso de herramientas y \emph{modelos} estad�sticos en investigaci�n.
Mi prop�sito es hacer claro c�mo funcionan dichos modelos y qu� herramientas nos sirven para justificar que en efecto dos variables est�n causalmente relacionadas.
Esto es importante, porque en muchos casos se suele decir que los \emph{modelos} usados en investigaci�n, sea cual sea su uso, son \say{falsos} 


\paragraph{Se suele se�alar} que hay un sentido en el cu�l los modelos son \say{falsos}, sentido que suele expresar como \say{[$\ldots$] models typically only hold \emph{approximately,} in some ranges of circumstances, and they liberally employ idealizations to accomplish this \emph{partial} fit.} \parencite[p.~18, �nfasis agregado]{Potochnik2017-POTIAT-3}

Potochnik tambi�n afirma que buena parte de la investigaci�n se centra en ofrecer explicaciones causales y, m�s a�n, afirma que una buena manera de lidiar con explicaciones causales en investigaci�n cient�fica es adoptando una teor�a causal \emph{manipulabilista.} 
Los argumentos de Potochnik que vinculan a la pr�ctica de investigaci�n con las teor�as \emph{manipulabilistas}, dejan claro que hay una genuina preocupaci�n sobre c�mo de hecho se realiza investigaci�n.

Potochnik tambi�n defiende que el uso de modelos en investigaci�n --y cualquier supuesto que imponga ciertas condiciones en el modelo-- surge de la necesidad de que seres con capacidades cognitivas limitadas queremos representar fen�menos naturales para aislar los factores causales bajo escrutinio. 
Es importante poner �nfasis en esto porque implica que los modelos \emph{son generados} con ciertos objetivos en mente, o como ella misma se�ala \say{[$\ldots$] the nature of these idealizations is relative to the aim of research, as is most clearly demonstrated by the different idealizations involved in the various approaches to human aggression research.} 

Mi investigaci�n actual lidia con la afirmaci�n de que los modelos son falsos. 
Este no es un problema grave si la \say{verdad} no es una parte central de la investigaci�n en cualquier �rea. 
Pero si la investigaci�n se propone \emph{justificar} hip�tesis para obtener \emph{conocimiento} de relaciones causales reales, entonces tenemos un problema.
�C�mo los modelos, que no representan adecuadamente el fen�meno, pueden dar como resultado conocimiento?
Si suponemos que el conocimiento es f�ctico, entonces entramos en problemas.

El problema, me parece, radica en c�mo representamos adecuadamente un fen�meno. 
Debo aclarar tambi�n c�mo es que funciona la representaci�n cient�fica y c�mo la adecuaci�n parcial de modelos que usan contara f�cticos, implica fen�menos f�cticos.

Mi hip�tesis es que cierta forma de verdad debe estar involucrada en nuestra definici�n de \emph{conocimiento,} si es que queremos que las intervenciones en un sistema sean de alguna utilidad. 
Por ejemplo, si el aumento del salario m�nimo causa un aumento en el desempleo y qu� condiciones juegan un papel causal en dicha relaci�n.

\paragraph{Regresando a la an�cdota,} el hecho de que estos dos profesores buenos trabajaran filosof�a de la
ciencia --al menos lo que en ese momento cre�a que era la filosof�a de la ciencia-- sesg� mis intereses a lo que hasta ahora ha sido mi trabajo.
La influencia de estos dos profesores me hizo tomar la decisi�n de entrar al posgrado en Filosof�a de la Ciencia.

En las clases de maestr�a hubo profesores excelentes.
Mucho de lo que aprend� en estos cursos me sirvi� para enmarcar de diferente manera las preguntas que me preocupaban, lo cu�l me permiti� entender --mejor, me parece-- la naturaleza de la investigaci�n cient�fica. 
En particular quer�a responder preguntas sobre la epistemolog�a de la ciencia, preguntas del tipo: \say{�qu� estamos justificados a creer?}, \say{�cu�ndo podemos afirmar que una hip�tesis ha sido corroborada?}, \say{�es la explicaci�n o compresi�n m�s b�sica que el conocimiento?}, etc. 
Preguntas que surgen a partir de mi inter�s por la explicaci�n causal.

Ahondar en estas preguntas y tratar de responderlas es una tarea m�s que complicada. 
Muchos de los obst�culos se deben a que la pr�ctica cient�fica es m�s ca�tica y heterog�nea de lo que parece en un principio. 
Incluso si nos concentramos en el uso de herramientas estad�sticas o herramientas que echan mano de la teor�a de la probabilidad, en casi todos los casos, ciertas propiedades del \emph{fen�meno en cuesti�n} son idealizadas o ignoradas para hacer que el modelo estad�stico sea de utilidad.

Esta representaci�n parcial del fen�meno se debe a que en muchos casos buscamos destacar algunas propiedades particulares del fen�meno, sin que todas las variables est�n representadas en el modelo.
Que no involucremos todas y cada una de las variables que afectan el fen�meno es un reflejo de nuestra limitada capacidad cognitiva.
A lo largo de su escrito, Potochnik nos recuerda que los modelos dise�ados en la investigaci�n cient�fica tienen un prop�sito particular. 
...
Que simplifiquemos de ciertas manera el modelo se debe a que los investigadores intentan resaltar las caracter�sticas de un fen�meno en un momento particular.

Potochnik no es la �nica que ha se�alado esto,
...
Biologists do often say things about evolution in infinite populations, and these claims are usually correct: the role of this terminology \emph{in practice} implies that it should not be understood literally.} (�nfasis agregado) 

A pesar de que los modelos no son completamente adecuados, --en el sentido en el que no representan totalmente el fen�meno en cuesti�n,-- son ampliamente utilizados en la investigaci�n cient�fica. 
Si estas herramientas son usadas ampliamente, entonces como fil�sofos de la ciencia hay que ofrecer un an�lisis de c�mo exactamente los modelos sirven para justificar hip�tesis 

En la maestr�a aprend� nuevas metodolog�as de investigaci�n, adem�s de diferentes maneras de plantear y entender las preguntas que me preocupaban. 
Pero sin lugar a dudas, lo m�s valioso que aprend�, fue la importancia que tiene la historia de la ciencia en la filosof�a de la ciencia. 
Me voy a permitir hacer una breve caracterizaci�n, exageradamente general, de dos posturas en historia de la ciencia.
