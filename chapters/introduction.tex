...
Una parte considerable del aprendizaje está relacionado con la filosofía,\sidenote{Juro que este breve relato tiene un punto. La otra parte no tiene que ver con filosofía, por tanto no aparecerá en el escrito.} lo que me dio la oportunidad de aprender much+isimo.
Además, la alta calidad del posgrado me permitió profundizar en los temas que me interesaban, y quiero mencionar que mi interés en estos temas nació durante mi licenciatura.

Durante la Licenciatura tuve profesores muy malos y un puñado de muy buenos profesores.
Pero mi interés en filosofía de la ciencia se debe a dos de ellos; ambos excelentes maestros y excelentes filósofos.
Todos los temas que vimos en clases fueron sumamente interesantes, pero mi atención la dirigí especialmente a la \emph{explicación científica} y la \emph{naturaleza de la causalidad}.
...
Intuición que no está muy alejada de algunas teorías de la explicación, por ejemplo
...
\noindent El siguiente será un breve y burdo repaso de las \say{metodologías}\sidenote{Esto que describo es igual a lo que Suárez llama \say{posturas}} \emph{externalistas} e \emph{internalistas}.
...
Al usar el término \emph{metodología}, no quiero comprometerme con si son teorías en contradicción, o teorías complemetarias; esto es algo que no puedo discutir aquí y el nombre \say{metodologías}, me parece, es lo suficientemente neutro\sidenote{
...
Creo que podemos identificar a Weinberg\sidenote{
...
Creo, además, que la investigación tiene como meta ofrecer explicaciones \emph{verdaderas} de los fenómenos; puedo decir entonces que me alíneo con Weinberg en un sentido restringido de \say{descubrimiento}\sidenote{
