...
\citetitle{Salmon1970}, que una teoría de la explicación científica debe
cumplir CA \citetitle{Salmon1970} y argumentó que el modelo clásico de
...
artículo \citetitle{Bromberger1966} y, hay que aclarar, qué papel
...
desarrollada por Hempel y Oppenheim en \citetitle{Hempel1948}.
...
Sabemos, por ejemplo, que \say{todos los metales se dilatan cuando se
	calientan.} Esta oración cuantificada universalmente implica deductivamente
...
En primer lugar, la oración cuantificada universalmente es crucial, no
...
\say{¿por qué mi cuchara se dilata cuando la caliento?}. Por ejemplo,
...
preguntamos a Cristian \say{¿por qué la altura del Empire State es de 381
	metros?} Cristian, que está al tanto del modelo por ley de cobertura,
...
Esto, por supuesto, resolvería el problema de la asimetría. A primera
...
Salmon considera que la clase de referencia que hemos definido, debe ser
...
} debe cumplir para que cuente como una explicación genuina. En
...
hace una diferencia,--- entonces la respuesta a \say{¿Por qué llovió el
	día de hoy?}, sería \say{Porque disminuyó la presión atmosférica y hubo
...
Antes de continuar con la exposicón de las teorías de la explicación,
quiero recapitular los detalles del modelo de Salmon. Primero,
debemos ser capaces de hacer una \say{partición homogénea} del fenómeno a
...
palabras de Galavotti \say{En esta perspectiva lo que cuenta para la
	explicación no es la alta probabilidad, como lo requería Hempel, sino
	estar en posición de afirmar que la distribución de probabilidad asociada
	con el	\emph{explanandum} refleja la información más completa y
	detallada	que podamos obtener}\footnote{
...
Esto significa que el modelo de Salmon aún tiene problemas relacionados
...
En estadística, es más que común el eslogan \say{correlación no implica
	causalidad} y el problema con el análisis de Salmon, tal como lo he
...
positivismo lógico.  Mucho esfuerzo filósfico se dedicó al tema de la causalidad y la explicación. Relevante para este contexto, por ejemplo, es que Lewis publicó \citetitle{Lewis1973-LEWC, Lewis1973-LEWC-2}: en el contexto de la explicación, Friedman publicó \citetitle{Friedma}. Otros esfuerzos fueron dedicados a aclarar el concepto de explicar \parencite{} hacer claro si es que la causalidad juega un papel en la explicación científicay si juega un papel, cuál \parencite{Ca}. Siguiendo algunas de las soluciones que ofreció Salmon al resolvcer el problema de la asimetría ---entre
...
estén resueltos todos los problemas filosóficos que acarrean. En este trabajo de investigación, me voy a dedicar a discutir el problema que ha recibido el nombre de \say{el problema fundamental de la inferencia causal.} Dicho en una oración: que no es posible saber el valor de verdad de un
condicional \emph {contrafáctico}. Si por definición del condicional, estamos evaluando algo que no sucede, pero que pudo haber sucedido: exactamente qué evidencia podemos ofrecer para justificar condicionales como \say{si los españoles no hubieran conquistado México, entonces conservaríamos todas nuestras reservas de oro.}
