...
\else
	\usepackage[spanish, english]{babel} % Load characters and hyphenation
\fi
...
\titlehead{¿Realmente Importa?}
\subject{Tesis de doctorado}

\title[¿Realmente Importa?]{¿Realmente Importa?}
\subtitle{Contrafácticos y el valor epistémico de la verdad}

%\author[Federico Marotta]{Federico Marotta\thanks{A \LaTeX\ lover}}
\author[Abraham Olivetti]{Oscar Abraham Olivetti Alvarez}
\date{\today}

\publishers{Universidad Nacional Autónoma de México}
...
\dedication{
	Questlove in particular had come to worship Jay Dee as a guru who liberated him from the idea of keeping perfect time, and instead imparted a permission to be loose, to be human, to be wrong.\\
	\flushright -- Dan Charnas
}
