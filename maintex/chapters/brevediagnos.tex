...
\noindent No debe haber mucha resistencia si afirmo que la investigación
científica tiene como objetivo alguna forma de conocimiento: ya sea
\textit{predecir} fenómenos, \textit{explicar} fenómenos,
\textit{catalogar} fenómenos, etc. En principio parece sensato señalar que
al realizar esta actividad y lograr sus objetivos, los investigadores
descubren cómo \textit{de hecho} es el mundo.

Otras actividades humanas---el arte, por ejemplo---no tienen claramente
objetivos epistémicos. Cualquiera que sea el objetivo epistémico de
esta actividad, está supeditado a la definición tripartita. Recordemos que
los contraejemplos Gettier muestran que la definición tripartita no es
suficiente \cite{gettier1963}, pero no implica que los elementos involucrados no sean necesarios: involucra verdad.
Lo anterior implica que es necesario que: si un sujeto
cualquiera tiene conocimiento de que $p$, entonces $p$ es una proposicióín verdadera.
Si esto es  correcto para todo objetivo epistémico, entonces vale
para los casos particulares en los que el sujeto en cuestión tenga como
objetivo realizar una predicción, explicar o catalogar fenómenos. Poniendo
todo esto en términos crasos: al lograr cualquier objetivo epistémico de la
investigación, obtenemos una impresión verdadera de cómo es el mundo.

Para motivar la conclusión anterior, quiero enfatizar que cuando los
investigadores fallan en sus objetivos, influyen de forma negativa en
dominios no epistémicos. El caso más claro de esto es que usamos los
resultados de la investigación, por ejemplo, para informar políticas
públicas para lidiar con el cambio climático y el calentamiento global
\parencite{stern2007}. Ambos son fenomenos que involucran aspectos tanto
económicos y sociales, como químicos, físicos y biológicos. Este fenómeno
es tan apremiante que dar acertadamente (en términos de conocimiento) con
la respuesta es de suma importancia. Si bien no siempre logramos el
objetivo en cuestión, al menos podemos acordar en que las políticas
públicas diseñadas para resolver problemas sociales \textit{deberían} estar
diseñadas tomando en cuenta la evidencia pertinente según sea el caso.

Esto, en espíritu, es algo que deja bien ilustrado Lynch al decir \say{That
is why democracies around the world must urgently redouble their commitment
to epistemic infrastructure---to the institutions and practices that
undergird the responsible search for truth. That means protecting science
and history from political intrusion} \citeyear{lynch2025truth}. Estoy
parcialmentes de acuerdo con lo que dice el autor---resta discutir a qué se
refiere con \say{democracia} e \say{intrusión política}---hasta el punto en
el no es controvertido decir que al menos una parte de nuestra política
pública debería basar sus decisiones en la infraestructura epistémica
responsable de la búsqueda de la verdad. Esta infraestructura, según
entiendo, es una actividad como la que he descrito hasta ahora.

De suyo, este traslape es motivación suficiente para analizar el papel que
la verdad juega en la investigación, pero debo aclarar que esto sólo empuja
el problema un paso atrás. Si bien puedo asegurar que vagamente acordamos
con lo mencionado en los párrafos anteriores, esta imagen intuitiva tiene
problemas que los filósofos de la ciencia han discutido ampliamente. Es en
esta disciplina y afines donde encontramos razones para dudar que la
investigación científica---la infraestructura epistémica encargada de la
búsqueda de la verdad---sea exitosa en sus objetivos. Razones
para dudar de que la verdad esté entre los objetivos de la
investigación. Los argumentos van desde defender que las creencias falsas
son y pueden ser de utilidad para lograr objetivos epistémicos
\parencite{elgin2004, elgin2017true}. Que la investigación científica no
produce verdad en ningún sentido interesante \parencite{Shapin1995}. Que aún si los
objetivos epistémicos son valiosos porque implican verdad, hay otros
estados epistémicos---como la comprensión, la sabiduría, la racionalidad,
etc---que no implican verdad\footnote{Quiero implicar con esto que si la
ciencia tiene objetivos epistémicos, entonces cabe la posibilidad de que la
ciencia logre sus objetivos, sin que haya ningún sentido de verdad
involucrada} y son estados epistémicos valiosos \parencite{kvanvig2003}.

El desarrollo de los argumentos anteriores involucra detalles que dejaré
para capítulos posteriores, pero puedo asegurar que las afirmaciones
previas concuerdan en al menos un punto: que podemos deshacernos de la
noción de verdad en investigación. Podemos deshacernos de ella porque no es
útil para analizar el desarrollo de la investigación científica.

\paragraph{Siendo sincero,} me parece que las afirmaciones anteriores
resultan de la mala concepción del concepto de ``verdad'' que suele estar
involucrado en estos debates. Debo señalar que una parte de mi trabajo---y
una de las premisas para mi argumento--- es intentar convencerlos de que
hay que recuperar un concepto particular de ``verdad'' para intentar
aclarar parte del debate.
%En este trabajo no %me concentro en el debate
%realismo antirrealismo, pero creo que
% %lo que %defenderé en esta tesistiene consecuencias en ese debate.
A lo largo de este trabajo voy a partir de un marco
proposicional. Las proposiciones son los objetos que pueden ser verdaderos
o falsos. El valor de verdad de una proposición está determinado por el
contenido semántico de la misma. Contenido semántico que depende de una
relación externa entre las proposiciones y el mundo. Esto es suficiente
para decir que la teoría de la verdad en la cuál estoy pensando, cae bajo
la categoría de una ``teoría correspondentista'' de la verdad
\cite{rasmussen2014, sep-truth}. Es correspondentista porque la tesis
central es que sea cuál sea el contenido de una oración---dada una
proposición cualquiera---su valor de verdad está determinado por la
relación que hay entre la proposición y el mundo, esto es, que la oración
corresponde adecuadamente con ``los hechos.''

Lo anteorior es una caracterización mínima de lo que es una teoría
correspondentista. No he dicho nada acerca de cuál es la naturaleza de las
proposiciones, ni acerca de la naturaleza de la relación entre las
proposiciones y el mundo. Tampoco he señalado nada en torno a cuál es la
naturaleza de los hechos a los cuáles las proposiciones corresponden.
Detallar cualquiera de estos aspectos implica diferentes versiones de una
teoría correspondentista. Tampoco me corresponde crear una caracterización
particular de la teoría, que es algo fuera de los límites de este trabajo.
Afortunadamente, en el mercado filosófico, tengo a la mano una formulación
particular que me permite analizar los aspectos de la investigación
científica. De esto trata el primer capítulo.
...
está atravesado por decisiones políticas y económicas. Además, los sesgos y
...
sin tener que presentar un escrito que mis lectores lean y critiquen con el
objetivo de evaluar argumentos y señalar errores. Para aquellos que
...
\cite{archimedes_method_1912}. El hecho de que parte de la investigación
...
Si es verdad que la investigación es una actividad colaborativa, entonces,
en principio, las personas involucradas en este trabajo tienen el interés
de hablar con verdad---o al menos evitar los errores en la medida de lo
posible. Esto incluye el caso en el que las hipótesis que sostuvieron
fueron falsas o inadecuadas.
...
Esto suele generar incomodidades entre filósofos de la ciencia,
especialmente tomando en consideración los argumentos de Elgin, Kvanvig o
Shapin. Pero algo que se les suele olvidar a los filósofoso de la ciencia
