...
es pasar a reconocer---investigar es la palabra que se antoja---que hay un objeto que tiene cierta propiedad particular. Juzgar, en un contexto cotidiano, es afirmar
...
juicio en la vida cotidiana, no veo cómo \textit{mentir} en este contexto, difiere del contexto de la investigación científica, por lo menos en lo que respecta al proceso de juzgar. Si esto es verdad y el contexto de investigación cumple con las suficientes características para caer bajo el principio de cooperación de Grice \parencite{}, entonces podemos decir que la investigación es una actividad en
la que esperamos que los involucrados, por lo menos, cooperen \textit{no mintiendo}---acorde con
...
verdadera o falsa. Un estándar obvio es que un investigador cualquiera, al menos haya intentado juzgar a sus oraciones de manera tal que pueda afirmar si su oración es verdadera o falsa. Esperamos que este juicio se haya formado usando además evidencia pertinente para afirmar que su juicio es verdadero. Además, creo que es obvio que asumimos que la disyunción discutida por Frege no se presenta en este caso. No se presenta porque cuando una persona afirma que ``los electrones tienen carga negativa,'' asumimos que ambos entendemos, aunque sea vagamente, qué es un electrón y qué es tener carga negativa. La pregunta de si el electrón existe o no, no se presenta, porque asumimos que estamos hablando de algo. Poniéndolo en forma de pregunta ¿por que a alguien en el contexto de investigación le interesaría hablar de objetos que no existen? En principio, hablar de objetos que asumimos que no existen es excluyente con la actividad de juzgar caracterizada anteriormente: cuando hablamos seriamente de objetos que no existen, perdemos el punto del goce estético. Esto sucede en el caso en el que hacemos juicios sobre si lo que sucede en las novelas de Conan Doyle es verdadero o falso. En segundo lugar, porque en el contexto de investigación, si llega a presentarse la pregunta sobre la existencia---por ejemplo, de electrones,--- 


os juicios son verdaderos o falsos y del hecho de que la
